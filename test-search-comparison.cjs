...
const testScenarios = [
  ...
  },
  {
    ...
    expectedUrl: 'https://meqasa.com/properties-for-rent-in-ghana',
    manualCheckUrl: 'https://meqasa.com/properties-for-rent-in-ghana (Filter: Type > Apartment)',
  },
  {
    ...
    expectedUrl: 'https://meqasa.com/properties-for-rent-in-ghana',
    manualCheckUrl: 'https://meqasa.com/properties-for-rent-in-ghana (Filter: Type > House)',
  },
  {
    ...
    expectedUrl: 'https://meqasa.com/properties-for-rent-in-ghana',
    manualCheckUrl: 'https://meqasa.com/properties-for-rent-in-ghana (Filter: Beds > 3)',
  },
  {
  ...
  },
  {
    ...
    expectedUrl: 'https://meqasa.com/properties-for-rent-in-accra',
    manualCheckUrl: 'https://meqasa.com/properties-for-rent-in-accra (Filter: Type > Apartment, Beds > 2)',
  },
  {
    ...
    expectedUrl: 'https://meqasa.com/properties-for-rent-in-ghana',
    manualCheckUrl: 'https://meqasa.com/properties-for-rent-in-ghana (Filter: Price 1000-5000)',
  },
  {
    ...
    expectedUrl: 'https://meqasa.com/properties-for-rent-in-ghana',
    manualCheckUrl: 'https://meqasa.com/properties-for-rent-in-ghana (Filter: Furnished Only)',
  },
  {
    ...
    manualCheckUrl: 'https://meqasa.com/properties-for-sale-in-accra (Filter: Type > House)',
  },
  {
    ...
    manualCheckUrl: 'https://meqasa.com/properties-for-rent-in-ghana (Filter: Rent Period > Daily)',
  },
  {
    ...
    expectedUrl: 'https://meqasa.com/properties-for-rent-in-ghana',
    manualCheckUrl: 'https://meqasa.com/properties-for-rent-in-ghana (Filter: Type > Office)',
  },
  {
    ...
    expectedUrl: 'https://meqasa.com/properties-for-rent-in-ghana',
    manualCheckUrl: 'https://meqasa.com/properties-for-rent-in-ghana (Sort: Highest-to-lowest price)',
  },
];
  ...
  try {
    ...
    if (result.status === 200 && result.data) {
      ...
      if (result.data.results && result.data.results.length > 0) {
        ...
        console.log(`   Summary: ${firstProperty.summary?.substring(0, 60)}...`);
        console.log(`   Price: ${firstProperty.pricepart1} ${firstProperty.pricepart2 || ''}`);
