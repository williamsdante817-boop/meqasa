...
export function DevelopersSkeleton() {
  return (
    <div role="status" aria-label="Loading developers">
                ...
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <Skeleton variant="light" size="default" className="w-32" />
                    </div>

                    {/* Badges skeleton */}
                    <div className="flex items-center gap-3 mb-3">
                      <Skeleton variant="light" className="h-6 w-20 bg-brand-badge-verified/20 rounded-sm" />
                      <Skeleton variant="light" className="h-6 w-24 bg-brand-badge-ongoing/20 rounded-sm" />
                    </div>
                  </div>

                  {/* Button skeleton */}
                  <Skeleton variant="light" className="h-10 w-32 bg-brand-primary/20 rounded-md" />
                </div>
              </div>
            </div>
      ...
      <span className="sr-only">Loading developers information, please wait...</span>
    </div>
  );
}
