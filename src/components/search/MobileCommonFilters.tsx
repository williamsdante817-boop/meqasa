    ...
    <div className="space-y-6 pb-4">
        ...
        <div className="flex flex-col gap-3 text-left">
          ...
          >
            <SelectTrigger className="h-12 bg-gray-50 border-gray-200 rounded-lg shadow-none text-base text-gray-700">
              <SelectValue placeholder="Select property type" className="text-base text-gray-700" />
            </SelectTrigger>
            <SelectContent>
      ...
      {isShortLet && (
        <div className="flex flex-col gap-3 text-left">
          ...
          >
            <SelectTrigger className="h-12 bg-gray-50 border-gray-200 rounded-lg shadow-none text-base text-gray-700">
              <SelectValue placeholder="Select duration" className="text-base text-gray-700" />
            </SelectTrigger>
            <SelectContent>
      ...
      {!hideBedBath && formState.propertyType !== "land" && (
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col gap-3 text-left">
            ...
            >
              <SelectTrigger className="h-12 bg-gray-50 border-gray-200 rounded-lg shadow-none text-base text-gray-700">
                <SelectValue placeholder="Any" className="text-base text-gray-700" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="- Any -" className="h-12 text-base text-gray-700">
                  Any
