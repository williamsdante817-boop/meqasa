...
export function PropertyCardSkeleton({
  ...
  return (
    <Card
      className={cn(propertyCardSkeletonVariants({ variant, hover, className }))}
      role="status"
      ...
      <CardContent className="px-0 pb-0 space-y-1">
        ...
        <div>
          ...
          <div className="mt-1 flex items-center text-base text-brand-muted flex-nowrap overflow-hidden" aria-label="Property features">
            ...
            <Skeleton variant="light" className="h-3 w-3 rounded-full bg-brand-accent/20 flex-shrink-0 mx-1" />
            {/* Baths skeleton */}
