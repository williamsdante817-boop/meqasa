        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 gap-4">
            <div className="space-y-2">
              <Label htmlFor="min-price" className="text-sm font-medium text-brand-accent">Minimum Price</Label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-brand-muted text-sm font-medium">{currency}</span>
                <Input
                  id="min-price"
                  placeholder="0"
                  type="number"
            ...
            <div className="space-y-2">
              <Label htmlFor="max-price" className="text-sm font-medium text-brand-accent">Maximum Price</Label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-brand-muted text-sm font-medium">{currency}</span>
                <Input
                  id="max-price"
          ...
          {showQuickSelections && variant !== 'compact' && (
            <div className="border-t border-gray-100 pt-4">
              <p className="text-xs font-medium text-brand-muted mb-3">Popular ranges</p>
