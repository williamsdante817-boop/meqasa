...
export const PropertyErrors = {
  NOT_FOUND: "Property not found. It may have been removed or the link is incorrect.",
  INVALID_REFERENCE: "Invalid property reference number. Please check and try again.",
 ...
 */
export function createPropertyError(error: unknown, type?: keyof typeof PropertyErrors): Error {
